...
class Measure(Processor):
    ...
    def build_tagger(self):
        ...
        # two_left = string_file(get_abs_path('chinese/data/chinese_two/two_left.tsv'))
        two_right = string_file(get_abs_path('chinese/data/measure/units_zh.tsv'))
        ...
        unit = (accep('年') | accep('年度') | accep('赛季') | 
                accep('全英') | accep('全法') | accep('全国') | 
                accep('全美') | accep('全澳') | accep('全日') | 
                accep('全德') | accep('全意') | accep('全西') | 
                accep('全俄') | accep('全韩') | accep('全欧'))
